function Controller() {
    ...
    $.__views.__alloyId6.add($.__views.indexView);
    ...
    $.__views.indexView.add($.__views.__alloyId7);
    $.__views.news = Ti.UI.createButton({
        left: 30,
        title: "News",
        id: "news"
    });
    $.__views.__alloyId7.add($.__views.news);
    ...
    $.__views.__alloyId7.add($.__views.schedule);
