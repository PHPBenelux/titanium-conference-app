function Controller() {
    ...
    $.__views.__alloyId12.add($.__views.indexView);
    ...
    $.__views.indexView.add($.__views.__alloyId13);
    $.__views.news = Ti.UI.createButton({
        left: 30,
        title: "News",
        id: "news"
    });
    $.__views.__alloyId13.add($.__views.news);
    ...
    $.__views.__alloyId13.add($.__views.schedule);
    ...
    $.__views.__alloyId13.add($.__views.about);
