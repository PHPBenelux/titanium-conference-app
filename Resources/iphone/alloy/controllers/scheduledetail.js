function Controller() {
    ...
    $.__views.__alloyId23.add($.__views.nameLabel);
    $.__views.pictureView = Ti.UI.createImageView({
        borderRadius: 5,
        id: "pictureView"
    });
    $.__views.__alloyId23.add($.__views.pictureView);
    ...
    $.__views.__alloyId23.add($.__views.bioLabel);
    ...
    $.__views.__alloyId25.add($.__views.dateLabel);
    ...
    $.__views.__alloyId27.add($.__views.roomLabel);
    ...
    $.__views.__alloyId29.add($.__views.levelLabel);
    ...
    $.__views.__alloyId24.add($.__views.__alloyId31);
    ...
    $.__views.__alloyId31.add($.__views.typeLabel);
