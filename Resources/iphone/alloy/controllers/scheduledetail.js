function Controller() {
    ...
    $.__views.scheduleDetailWindow.add($.__views.__alloyId57);
    ...
    $.__views.__alloyId57.add($.__views.titleLabel);
    $.__views.descriptionLabel = Ti.UI.createLabel({
        id: "descriptionLabel"
    });
    $.__views.__alloyId57.add($.__views.descriptionLabel);
    ...
    $.__views.__alloyId57.add($.__views.pictureView);
    $.__views.bioLabel = Ti.UI.createLabel({
        id: "bioLabel"
    });
    $.__views.__alloyId57.add($.__views.bioLabel);
    ...
    $.__views.__alloyId61.add($.__views.roomLabel);
    ...
    $.__views.__alloyId63.add($.__views.levelLabel);
    ...
    $.__views.__alloyId65.add($.__views.typeLabel);
